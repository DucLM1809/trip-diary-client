  ...
  const locations = [
    {
      ...
      date: "2/6/2021",
      image: [destination1, destination2,destination1, destination2,destination1],
      description:
  ...
  return (
    <div className="flex flex-col justify-center mx-auto mt-10 w-[1100px]">
      <div className="border-1 border-gray flex flex-col justify-between w-full h-full mb-10 rounded-10 shadow-lg overflow-y-auto pb-10">
        <h1 className="text-3xl text-center mb-5 mt-10 ">
          {tripName}
        </h1>
          ...
          return (
            <div>
              ...
              <div className="flex flex-col items-center mb-5">
                ...
                <div className="flex justify-left w-4/5 mt-3">
                  <span className="text-base ml-2 font-light">{location.description}</span> 
                </div>
                <div className="flex justify-center gap-1 w-4/5 mt-3">

                <Swiper
              slidesPerView={(location.image.length < 3) ? location.image.length : 3}
              spaceBetween={30}
              freeMode={true}
              pagination={{
                clickable: true,
            ...
            >
                ...
                {location.image.map((img)=>{
                    return(
                        <div>
                        <SwiperSlide> <img src={img} alt="" className="w-[250px] h-[250px]" /> </SwiperSlide>
              </div>
                    );
                })}
